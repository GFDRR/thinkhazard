...
file_loc = "ADM1_TH.csv"
code_data = pd.read_csv(file_loc, sep=';')

adm1_codes = code_data['ADM1_CODE'].tolist()
adm1_urls = [target_url.format(adm_code) for adm_code in adm1_codes]

# List of things to do asynchronously
url_responses = []
for url in adm1_urls:
...
print(result_df)
result_df.to_csv('TH_ADM1_ext.csv', sep=';')
