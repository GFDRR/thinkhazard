...
def populate_datamart():
    ...
    div_level_3_0 = AdministrativeDivision(
        **{"code": 30, "leveltype_id": 3, "name": "Division level 3 - 1"}
    )
    ...
    div_level_3_3 = AdministrativeDivision(
        **{"code": 33, "leveltype_id": 3, "name": "Division level 3 - 3"}
    )
    ...
    div_level_3_4 = AdministrativeDivision(
        **{"code": 34, "leveltype_id": 3, "name": "Division level 3 - 4"}
    )
    ...
    div_level_3_5 = AdministrativeDivision(
        **{"code": 35, "leveltype_id": 3, "name": "Division level 3 - 5"}
    )
    ...
    div_level_3_6 = AdministrativeDivision(
        **{"code": 36, "leveltype_id": 3, "name": "Division level 3 - 6"}
    )
...
def populate_processing():
    ...
    admin30 = (
        ...
        .filter(AdministrativeDivision.code == 30)
        .one()
    )
    ...
    admin31 = (
        DBSession.query(AdministrativeDivision)
        .filter(AdministrativeDivision.code == 31)
        .one()
    )
    output2 = Output()
    ...
    admin32 = (
        DBSession.query(AdministrativeDivision)
        .filter(AdministrativeDivision.code == 32)
        .one()
    )
    output4 = Output()
    ...
    admin33 = (
        DBSession.query(AdministrativeDivision)
        .filter(AdministrativeDivision.code == 33)
        .one()
    )
    output6 = Output()
    ...
    admin34 = (
        DBSession.query(AdministrativeDivision)
        .filter(AdministrativeDivision.code == 34)
        .one()
    )
    output8 = Output()
    ...
    admin35 = (
        DBSession.query(AdministrativeDivision)
        .filter(AdministrativeDivision.code == 35)
        .one()
    )
    output10 = Output()
